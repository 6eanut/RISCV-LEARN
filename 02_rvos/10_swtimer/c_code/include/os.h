...
extern is_locked spin_lock(lock *);
extern void spin_unlock(lock *);

extern uint32_t swtimer_create(void (*)(void *), void *, uint32_t);
extern void swtimer_delete(uint32_t);
