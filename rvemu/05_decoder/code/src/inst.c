...
// to do list: rvc-> 01 02

// RV Standard
inst_t inst_utype_read(uint32_t raw_inst)
{
...
inst_t inst_jtype_read(uint32_t raw_inst)
{
...
inst_t inst_itype_read(uint32_t raw_inst)
{
...
inst_t inst_btype_read(uint32_t raw_inst)
{
...
inst_t inst_stype_read(uint32_t raw_inst)
{
...
inst_t inst_rtype_read(uint32_t raw_inst)
{
    return (inst_t){
        .rd = RD(raw_inst),
        .rs1 = RS1(raw_inst),
...
inst_t inst_csr_read(uint32_t raw_inst)
{
    return (inst_t){
        .rd = RD(raw_inst),
        .rs1 = RS1(raw_inst),
...
inst_t inst_r4type_read(uint32_t raw_inst)
{
    return (inst_t){
        .rd = RD(raw_inst),
        .rs1 = RS1(raw_inst),
...
// RVC
inst_t inst_ciwtype_read(uint16_t raw_inst)
{
...
inst_t inst_cltype_read1(uint16_t raw_inst)
{
...
inst_t inst_cltype_read2(uint16_t raw_inst)
{
    uint32_t imm5_3 = (raw_inst >> 10) & 0x7;
    uint32_t imm2 = (raw_inst >> 6) & 0x1;
...
inst_t inst_cstype_read1(uint16_t raw_inst)
{
    uint32_t imm5_3 = (raw_inst >> 10) & 0x7;
    uint32_t imm7_6 = (raw_inst >> 5) & 0x3;
    int32_t imm = (imm5_3 << 3) + (imm7_6 << 6);
...
inst_t inst_cstype_read2(uint16_t raw_inst)
{
    uint32_t imm5_3 = (raw_inst >> 10) & 0x7;
    uint32_t imm2 = (raw_inst >> 6) & 0x1;
    uint32_t imm6 = (raw_inst >> 5) & 0x1;
...
inst_t inst_cimm540_read(uint16_t raw_inst)
{
...
inst_t inst_cimm946875_read(uint16_t raw_inst)
{
...
inst_t inst_cimm171612_read(uint16_t raw_inst)
{
...
inst_t inst_cimm114981067315_read(uint16_t raw_inst)
{
...
inst_t inst_cimm84376215_read(uint16_t raw_inst)
{
...
inst_t inst_cimm54386_read(uint16_t raw_inst)
{
    uint32_t imm5 = (raw_inst >> 12) & 0x1;
...
inst_t inst_cimm54276_read(uint16_t raw_inst)
{
    uint32_t imm5 = (raw_inst >> 12) & 0x1;
...
inst_t inst_cimm5386_read(uint16_t raw_inst)
{
    uint32_t imm5_3 = (raw_inst >> 10) & 0x7;
...
inst_t inst_cimm5276_read(uint16_t raw_inst)
{
